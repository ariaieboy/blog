<footer class="bg-base-200 text-base-content border-t border-base-300 mt-auto">
    <div class="max-w-2xl mx-auto p-8 flex flex-col items-center gap-4">
        ...
        <nav class="flex gap-4">
            <a href="https://github.com/ariaieboy" target="_blank" rel="noopener noreferrer" class="btn btn-ghost btn-circle btn-sm" title="GitHub">
            ...
            <a href="https://x.com/ariaieboy_ir" target="_blank" rel="noopener noreferrer" class="btn btn-ghost btn-circle btn-sm" title="X (Twitter)">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://bsky.app/profile/ariaieboy.ir" target="_blank" rel="noopener noreferrer" class="btn btn-ghost btn-circle btn-sm" title="Bluesky">
            ...
            <a href="/blog/feed.atom" class="btn btn-ghost btn-circle btn-sm" title="RSS Feed">
